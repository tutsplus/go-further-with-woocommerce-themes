...
//add attributes to the menus
function tutsplus_attributes_menus( $register, $name = '' ){
	if ( $name == 'pa_range' || 'pa_audience' ) $register = true;
	return $register;
}  
add_filter ( 'woocommerce_attribute_show_in_nav_menus', 'tutsplus_attributes_menus', 1 )
?>